...
void GR(double t, gsl_vector* y, gsl_vector* dydt){
	double m1 = 10;//gsl_vector_get(y,18);	
	double m2 = 10;//gsl_vector_get(y,19);	
	double m3 = 10;//gsl_vector_get(y,20);	
	double G = 1;// gsl_vector_get(y,21);	
	// get s
